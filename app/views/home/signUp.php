        ...
        <div class="col-md-6 col-md-offset-3">
            ...
            <form role="form" action="<?= URL ?>/register/run" method="post">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group <?php echo ($this->data['username'] === true ) ? 'has-error' : '' ?>">
                            <input type="text" value="<?php echo (isset($this->data['username']) && $this->data['username'] !== true) ? $this->data['username'] : '' ?>" name="username" class="form-control input-lg" placeholder="User Name" tabindex="5" required autofocus>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group <?php echo ($this->data['displayname'] === true ) ? 'has-error' : '' ?>">
                            <input type="text" value="<?php echo (isset($this->data['displayname']) && $this->data['displayname'] !== true) ? $this->data['displayname'] : '' ?>" name="displayname" class="form-control input-lg" placeholder="Display Name" tabindex="6" required>
                        </div>
                    </div>
                </div><!-- end row -->
                <div class="form-group <?php echo ($this->data['email'] === true ) ? 'has-error' : '' ?>">
                    <input type="email" value="<?php echo (isset($this->data['email']) && $this->data['email'] !== true) ? $this->data['email'] : '' ?>" name="email" class="form-control input-lg" placeholder="Email Address" tabindex="7" required>
                </div>
                ...
                <div class="form-group">
                    <input type="text" value="<?php echo (isset($this->data['flatCode']) && $this->data['flatCode'] !== true) ? $this->data['flatCode'] : '' ?>" name="flat_code" class="form-control input-lg" placeholder="Flat Code (if available)" tabindex="9">
                </div>
                <div class="form-group">
